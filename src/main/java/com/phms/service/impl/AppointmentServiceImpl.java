...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public void add(Appointment categorization) {
        appointmentMapper.insertSelective(categorization);
    }
    ...
    @Override
    public List<Map<String, Object>> getFreeTimeByDoc(Long docId, String s) {
        return appointmentMapper.getFreeTimeByDoc(docId, s);
    }
}
