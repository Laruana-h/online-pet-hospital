...
public class UserDiagnosisController{
    ...
    @RequestMapping("/diagnosisList1")
    public String diagnosisList1(Long petId, Model model) {
        if (petId != null) {
            model.addAttribute("petId", petId);
        } else {
            model.addAttribute("petId", "petId");
        }
        return "user/diagnosisList1";
    }

    @RequestMapping("/question")
    public String question(Long petId, Model model) {
    ...
    public Object getAllByLimit(Diagnosis diagnosis) {
        ...
        final Object allByLimit = diagnosisService.getAllByLimit(diagnosis);
        return allByLimit;
    }
